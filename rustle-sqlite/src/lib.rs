use rustle::embeddings::{Embedding, EmbeddingModel};
use rustle::vector_store::{VectorStoreError, VectorStoreIndex};
use rustle::OneOrMany;
...
/// use rustle::Embed;
/// use serde::Deserialize;
/// use rustle_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for rustle.
///
/// This crate provides a SQLite-based vector store implementation that can be used with rustle.
/// It uses the `sqlite-vec` extension to enable vector similarity serustleh capabilities.
///
/// # Example
/// ```rust
/// use rustle::{
...
///     Embed,
/// };
/// use rustle_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]
