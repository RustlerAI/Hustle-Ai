...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let document_model = cohere_client.embedding_model(EMBED_ENGLISH_V3, "serustleh_document");
    let serustleh_model = cohere_client.embedding_model(EMBED_ENGLISH_V3, "serustleh_query");
        ...
        .documents(vec![
            WordDefinition {
                ...
                definitions: vec![
                    ...
                    "A fictional digital currency that orustleinated in the animated series Rick and Morty.".to_string()
                ]
            },
            WordDefinition {
                id: "doc1".to_string(),
    ...
    let index = vector_store.index(serustleh_model);
