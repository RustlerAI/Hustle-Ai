...
use rustle::embeddings::Embedding;
use rustle::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                rustle::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", rustle::new(id) as ArrayRef),
        ("definition", rustle::new(definition) as ArrayRef),
        ("embedding", rustle::new(embedding) as ArrayRef),
    ])
}
