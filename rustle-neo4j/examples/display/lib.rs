// =====================================================
// Utilities to print results from a Neo4j vector serustleh
// =====================================================
...
pub struct SerustlehResults<'a>(pub &'a Vec<SerustlehResult>);

impl<'a> Display for SerustlehResults<'a> {
