//! Simple end-to-end example of the vector serustleh capabilities of the `rustle-neo4j` crate.
...
use rustle_neo4j::{vector_index::SerustlehParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SerustlehParams::default())
        .await?;
